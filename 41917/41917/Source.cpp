...

{
	...
	//create 2 beam object

	beam2 = al_create_bitmap(3, 3);

	al_set_target_bitmap(beam2);

	al_clear_to_color(al_map_rgb(69, 1, 200));
...

	{
		...
		if (ev.type == ALLEGRO_EVENT_TIMER) {
			...
			if (shootBeam) {
				...
				beam_x = ship_x + t * 6 + 56;

				beam_y = ship_y + 30 * sin(.5*t) + 21;

				beam2_x = ship_x + t * 21 + 99;

				beam2_y = ship_y + 59 * sin(.69*t) + 21;
